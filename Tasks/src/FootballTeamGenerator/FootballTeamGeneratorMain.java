        ...
        while (!command.equals("END")) {
            ...
            switch (commandName) {
                case "Team":
                    ...
                    break;
                case "Add":
                    handleAddPlayer(commandParts[1],commandParts[2],commandParts[3],commandParts[4],
                            commandParts[5],commandParts[6], commandParts[7], teamsByName);
                    break;
                case "Remove":
                ...
                case "Rating":
                    ...
                    break;
                default: throw new IllegalStateException("Unknown command " + commandName);
            }
